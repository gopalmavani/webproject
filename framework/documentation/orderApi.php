...
<div class="content content-boxed">
    ...
    <div class="block box1">
        <div class="block-content block-content-full block-content-narrow">
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/order/add
            </p>
            <p><b>Type : </b>POST</p>
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/order/update/1</>
            <p><b>Type : </b>Put</p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
                <div class="panel-heading">
            ...
            <!--End update-->
            <!-- View -->
            <h4 class="h4 font-w600 push-30-t push">View All Order</h4>
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/order</>
            <p><b>Type : </b>GET</p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
                <div class="panel-heading">
            ...
            <!-- View Single-->
            <h4 class="h4 font-w600 push-30-t push">View Specific Order</h4>
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/order/2</>
            <p><b>Type : </b>Get</p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
                <div class="panel-heading">
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl']?>/app/api/order/delete/1</>
            <p><b>Type : </b>Delete </p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
                <div class="panel-heading">
    ...
    <div class="block box2">
        <div class="block-content block-content-full block-content-narrow">
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/order/addcart/
            </p>
            <p><b>Type : </b>POST</p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/viewallcart</>
            <p><b>Type : </b>GET</p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
                <div class="panel-heading">
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/order/viewcart/1</>
            <p><b>Type : </b>Get</p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
                <div class="panel-heading">
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/order/delete/cartdelete/1</>
            <p><b>Type : </b>Delete </p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
                <div class="panel-heading">
    ...
    <div class="block">
        <div class="block-content block-content-full block-content-narrow">
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/app/api/order/addmemo
            </p>
            <p><b>Type : </b>POST</p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var viewAll_obj = <?php echo json_encode($OrderViewAll, JSON_PRETTY_PRINT); ?>;
