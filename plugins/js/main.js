...
;(function () {
   ...
   /* $body.append("<a href='.html' class='BackToTop BackToTop--hide ScrollTo'><i class='fa fa-angle-up'></i></a>");
        ...
        function update() {
            ...
            $this.each(function() {
                ...
                if (top + height < pos || top > pos + windowHeight )
                    return;
                $this.css('backgroundPosition', '0% ' + Math.round((el_top - pos) * 1.4) + 'px');
            })
        }
    ...
    $('#counting-date').countdown('2018/08/06').on('update.countdown', function(event) {
        var $this = $(this).html(event.strftime(''
        + '<div class="count-block"><h3 class="u-FontSize30">%D</h3> <span>dagen</span> </div>'
        + '<div class="count-block"><h3 class="u-FontSize30">%H</h3> <span>uren</span> </div>'
        + '<div class="count-block"><h3 class="u-FontSize30">%M</h3> <span>minuten</span> </div>'
        + '<div class="count-block"><h3 class="u-FontSize30">%S</h3> <span>seconden</span></div>'));
    });
