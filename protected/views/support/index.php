<main id="main-container">
    ...
    <div class="bg-image" style="background-image: url('<?php echo Yii::app()->baseUrl; ?>/plugins/img/photos/photo3@2x.jpg.jpg');">
        <section class="block-content bg-primary-dark-op text-center overflow-hidden">
            <!-- Section Content -->
            <div class="push-100-t push-50 text-center">
                <h1 class="h2 text-white push-10 " data-toggle="appear" data-class="animated fadeInDown">Support Center.</h1>
            </div>
            <!-- END Section Content -->
        </section>
    </div>
    ...
    <div class="bg-gray-lighter">
        <section class="content content-full content-boxed">
            ...
            <div class="push-20-t push-20 text-center">
                <h3 class="h4 push-20 " data-toggle="appear">Can't find what you were looking for?</h3>
                <a class="btn btn-rounded btn-noborder btn-lg btn-success " data-toggle="appear" data-class="animated bounceIn" href="<?php echo Yii::app()->createUrl('/contactus/index')?>">Contact Us</a>
            </div>
            <!-- END Section Content -->
        </section>
    </div>
