...
/*echo "<pre>";
print_r($service);die;*/
$this->pageTitle = "Booking of ".$service->service_name;
$selecteddays = array();
$timingcolumn = array();
...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal" action="<?= Yii::app()->createUrl('/admin/services/bookingservice/')."/".$service->service_id; ?>" method="POST" style="width:100%">
