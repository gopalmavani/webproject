            ...
            <div class="col-md-12">
                ...
                <div id="wallet-grid">
					...
					foreach($array_cols as $key=>$col){
						...
						else if($col->name == 'transaction_comment'){
							?>
					            ...
					            foreach($arr as $key=>$col){
						            switch($col->name)
						            {
                                        ...
                                        case 'transaction_comment':
								            echo "<td><input type='text' data-column='6' class='text-box form-control' placeholder='Email' style='width:100%'></td>";
								            break;
...
//					console.info(json.data.length);
            ...
            "columnDefs": [ {
                ...
                "render" : function(data, type, row) {
                    return '<a href=" <?php echo Yii::app()->createUrl("admin/wallet/userbalanceview/").'/'; ?>'+data[14]+'"><i class="fa fa-eye"></i></a>';
                }
                //"defaultContent": "<a href=''><i class='fa fa-eye'></i></a>&nbsp;&nbsp;<a href=''><i class='fa fa-pencil'></i></a>&nbsp;&nbsp;<a href=''><i class='fa fa-times'></i></a>"
            },{
                "visible":false,
                "targets":[1,3,4,5,6,8,9,10,12,13,14,15]
            } ]
