...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'email',array('size'=>60,'maxlength'=>130)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'activekey'); ?>
		<?php echo $form->textField($model,'activekey',array('size'=>60,'maxlength'=>130)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'auth_level'); ?>
