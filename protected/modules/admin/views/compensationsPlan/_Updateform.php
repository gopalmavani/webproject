...
<div class="pull-right m-b-10">
    <?php echo CHtml::link('Go to list', array('unilevelplan/admin'), array('class' => 'btn btn-minw btn-square btn-warning')); ?>
</div>
<div class="row">
    <div class="col-lg-9">
        <div class="block">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-md-8 <?php echo $model->hasErrors('denomination') ? 'has-error' : ''; ?>">
                                <?php echo $form->textFieldControlGroup($model,'denomination',array('size'=>50,'maxlength'=>50, 'class' => 'form-control', 'placeholder' => 'Enter Denomination')); ?>
                            </div>
                        </div>
                        <div class="form-group col-md-12 ">
