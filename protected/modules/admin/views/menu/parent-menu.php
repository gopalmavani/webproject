...
<div class="block">
    ...
    <form id="parent_item_form" name="parent_item" action="<?php echo Yii::app()->createUrl('admin/menu/create/2'); ?>" method="post">
            ...
            <div class="col-md-12">
                <div class="col-md-6" style="padding-bottom: 10px;">
                    ...
                    <div class="input-group iconpicker-container">
                        <input class="form-control icp icp-auto" value="fa-user" name="ParentItem[MenuIcon]" id="menu_icon"/>
                        <span class="input-group-addon"></span>
                    </div>
                </div>
                <div class="col-md-6" style="padding-bottom: 10px;">
                    <label>Title</label>
                    <input type="text" class="form-control" name="ParentItem[Title]" id="title">
                </div>
                <div class="col-md-6" style="padding-bottom: 10px;">
                    <label>Visual Title</label>
                    <input type="text" class="form-control" name="ParentItem[Visual-Title]" id="visual_title">
                </div>
            </div>
