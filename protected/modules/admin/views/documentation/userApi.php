...
<div class="content content-boxed">
    ...
    <div class="block">
        <div class="block-content block-content-full block-content-narrow">
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/<?php echo $currentApp; ?>/api/user/add</p>
            <p><b>Type : </b>POST</p>
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/<?php echo $currentApp; ?>/api/user/update/1
            </>
            <p><b>Type : </b>Put</p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
            ...
            <!-- View Single-->
            <h4 class="h4 font-w600 push-30-t push">View User</h4>
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/<?php echo $currentApp; ?>/api/user/2</>
            <p><b>Type : </b>Get</p>
            <p><b>Content Type : </b>application/json</p>
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#faq3"
                           href="#request">JSON Request</a>
                    </h3>
                </div>
                <div id="request" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="json-format" id="view_request"></div>
                    </div>
                </div>
            </div>
            ...
            <p><b>End Point : </b><?php echo Yii::app()->params['siteUrl'] ?>/<?php echo $currentApp; ?>/api/user/delete/1
            </>
            <p><b>Type : </b>Delete </p>
            <p><b>Content Type : </b>application/json</p>
            <div class="panel panel-default">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var viewreq_obj = <?php echo json_encode($UserViewRequest, JSON_PRETTY_PRINT); ?>;
        prettyJson("view_request", viewreq_obj);
