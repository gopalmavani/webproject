...
$this->pageTitle = "<span lang='en'>Sliders</span>";
$tableName = Sliders::model()->tableSchema->name;
    ...
    $(document).ready(function() {
        ...
        var datatable = $('#<?php echo $tableName; ?>-table').DataTable({
            ...
            "buttons": [
                {
                    extend: 'copyHtml5',
                    title: 'Sliders Data export '+currentDate
                },
                {
                    extend: 'excelHtml5',
                    title: 'Sliders Data export '+currentDate
            ...
            "columnDefs": [ {
                ...
                "render" : function(data, type, row) {
                    return '<a href="javascript:void(0);" class="delete-FbFeed" id="'+data[1]+'"><i class="fa fa-times"></i></a>';
                }
            },{
                "visible":false,
                "targets":[1,3,4]
