...
class Wallet extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('created_at, modified_at, expiry_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('wallet_id, user_id, wallet_type_id, transaction_type, reference_id, reference_num, transaction_comment, denomination_id, transaction_status, portal_id, amount, updated_balance, created_at, modified_at, expiry_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('expiry_at',$this->expiry_at,true);
