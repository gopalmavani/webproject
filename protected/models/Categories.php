...
class Categories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('is_active, is_delete, is_parent, parent_id', 'numerical', 'integerOnly'=>true),
			...
			array('category_id, category_name, description, is_active, created_at, modified_at, is_delete, is_parent, parent_id, image', 'safe', 'on'=>'search'),
		);
	}
