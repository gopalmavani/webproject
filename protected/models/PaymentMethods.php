...
class PaymentMethods extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('payment_method_id, gateway, merchant_ref_id, key_name_1, key_value_1, key_name_2, key_value_2, parameters, url, action_url, portal_id, payment_comment, created_at, modified_at', 'safe', 'on'=>'search'),
		);
	}
